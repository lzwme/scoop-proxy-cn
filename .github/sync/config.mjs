...
export const CONFIG = {
  ...
  ghproxy: 'https://ghproxy.net', // 'https://ghproxy.net', https://gh.api.99988866.xyz, https://ghps.cc ,https://gh.ddlc.top
  /** 已失效的历史地址；用于兼容其他仓库的，避免套娃问题 */
  ghproxyInvalid: ['https://gh-proxy.com', 'https://mirror.ghproxy.com', 'https://ghproxy.com'],
  /** 同步仓库列表，按仓库质量排序 */
  repo: new Set([
